...
class _$SosAlertImpl implements _SosAlert {
  ...
  @override
  String toString() {
    return 'SosAlert(id: $id, userId: $userId, lat: $lat, lng: $lng, accuracy: $accuracy, batteryPct: $batteryPct, status: $status, triggerType: $triggerType, origin: $origin, resolvedAt: $resolvedAt, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userId, lat, lng, accuracy,
      batteryPct, status, triggerType, origin, resolvedAt, createdAt);
